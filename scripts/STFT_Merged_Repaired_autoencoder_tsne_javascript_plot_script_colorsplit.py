...
for p in range(1,4):
    ...
    # fp = open('25d_Merged_Repaired_no_dups_new_mel_autoencoder_try2_tsne_prx_' + str(prx) + '_l-rate_' + str(l_rate) + '_try_' + str(p) +'_v2.csv', 'w', encoding='utf-8')
    # x = []
    # y = []
    # for i in range (samples):
    #     fp.write(names[i])
    ...
    # fp.close()
    fp = open('50d_Merged_Repaired_no_dups_STFT_autoencoder_try1_tsne_prx_' + str(prx) + '_l-rate_' + str(l_rate) + '_try_' + str(p) +'_stdscale1.csv', 'r', encoding='utf-8')
    # fp = open('512d_Merged_Repaired_no_dups_mfcc_autoencoder_try0_tsne_prx_' + str(prx) + '_l-rate_' + str(l_rate) + '_try_' + str(p) +'_v2.csv', 'r', encoding='utf-8')
    x = []
    y = []
    ...
    for k in range(len(proper_names)):
        ...
        if 'Repaired' in names[k]:
            colors.append(color_opt[0])
        else:
            colors.append(color_opt[1])

    output_file('50d_Merged_Repaired_no_dups_STFT_autoencoder_try1_tsne_prx_' + str(prx) + '_l-rate_' + str(l_rate) + '_try_' + str(p) +'_colorsplit.html')
    # output_file('512d_Merged_Repaired_no_dups_mfcc_autoencoder_try0_tsne_prx_' + str(prx) + '_l-rate_' + str(l_rate) + '_try_' + str(p) +'_v2_colorsplit.html')
